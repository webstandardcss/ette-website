...
<div class="main-outer">
  ...
  <main class="main-content main-content-page main-content-page-about">
    ...
    <a href="http://www.eccolink.com/ProductPages/Products.cfm"><figure class="featured-brands-item">
        <img src="/obf/images/accessories/brands/ecco.jpg" alt="ECCO" />
        <figcaption>ECCO</figcaption>
      </figure></a>
      <a href="http://www.hella.com/produktion/HellaUSA/WebSite/Channels/Home/Home.jsp"><figure class="featured-brands-item">
        <img src="/obf/images/accessories/brands/hella.jpg" alt="Hella" />
        <figcaption>Hella</figcaption>
      </figure></a>
      <a href="http://www.pmlights.com/"><figure class="featured-brands-item">
      ...
      <a href="http://www.pilotautomotive.com/"><figure class="featured-brands-item">
